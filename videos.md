...
<span class="li bl">{% include partial_youtube.html id="NgdHdiDs53w" title="Okehampton & Sampford Courtenay - Bonus Video" %}</span>
...
<span class="li bl">{% include partial_youtube.html id="_X8eYyou0WU" title="Mobile Ticketing - Bonus Video, Day 75 - Sheffield to Retford [Sponspored Content]" %}</span>
...
### North East
<ul>
<span class="li bl">{% include partial_youtube.html id="0s3E6prIW9M" title="Teach Me Some Northern Words - Episode 47, Day 87 - Middlesbrough-Saltburn-Whitby" %}</span>
...
<span class="li rd">{% include partial_youtube.html id="ALd-ApLeIxQ" title="Choose Corrour" %}</span>
...
<span class="li bl">{% include partial_youtube.html id="y71VD3ISYU4" title="A Human BR Double Arrow Symbol" %}</span>
</ul>
